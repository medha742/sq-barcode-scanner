...
class CameraSource(private val graphicOverlay: GraphicOverlay) {
    ...
    private fun setPreviewAndPictureSize(camera: Camera, parameters: Camera.Parameters) {
        ...
        val sizePair: CameraSizePair = Util.getCustomRectCalculatedPreviewSize(context) ?: run {
            ...
            val displayAspectRatioInLandscape: Float =
                if (Util.isPortraitMode(graphicOverlay.context)) {
    ...
    companion object {
        ...
        private fun selectSizePair(
            ...
            val validPreviewSizes = Util.generateValidPreviewSizeList(camera)
            ...
            for (sizePair in validPreviewSizes) {
                ...
                if (abs(aspectRatioDiff - minAspectRatioDiff) < Util.ASPECT_RATIO_TOLERANCE) {
